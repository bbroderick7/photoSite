...
var _landingDesktop = __webpack_require__(239);

var _landingDesktop2 = _interopRequireDefault(_landingDesktop);
  ...
  _createClass(MyApp, [{
    ...
    value: function render() {
      ...
      var currentProjects = this.projectNames.map(function (proj) {
        return _react2.default.createElement(_reactRouterDom.Route, { key: proj, exact: true, path: '/projects/' + proj, render: function render() {
            return _react2.default.createElement(
              'div',
              null,
      ...
      var currentGalleries = this.galleryNames.map(function (gall) {
        return _react2.default.createElement(_reactRouterDom.Route, { key: gall, path: '/stills/' + gall, render: function render() {
            return _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(_header2.default, null),
      ...
      var landingPage = window.innerWidth < 1000 ? _react2.default.createElement(_landing2.default, null) : _react2.default.createElement(_landingDesktop2.default, null);
...
var NavBar = function NavBar() {
  return _react2.default.createElement(
    'div',
    { className: 'landingDesktop-typwriter' },
    _react2.default.createElement(
      'div',
      { className: 'row typewriter-container' },
      _react2.default.createElement(
...
var LandingDesktop = function (_Component7) {
  _inherits(LandingDesktop, _Component7);

  function LandingDesktop(props) {
    _classCallCheck(this, LandingDesktop);

    return _possibleConstructorReturn(this, (LandingDesktop.__proto__ || Object.getPrototypeOf(LandingDesktop)).call(this, props));
  }

  _createClass(LandingDesktop, [{
    key: 'render',
    value: function render() {
...
exports.default = (0, _reactRouterDom.withRouter)(LandingDesktop);
...
var Gallery = exports.Gallery = function (_Component) {
  ...
  _createClass(Gallery, [{
    ...
    value: function getNextPhoto(direction) {
      ...
      var imgrrr = this.state.photoTitles[new_selected_index];
      this.setState({
...
var createURL = function createURL(photoSetID) {
  ...
  _createClass(SubheaderNav, [{
    ...
    value: function render() {
      var subheaders = this.props.subheadings.map(function (subheading) {
        return _react2.default.createElement(
          "a",
          { key: subheading, href: subheading },
          _react2.default.createElement(
            "h3",
            { id: subheading + "pics" },
            subheading
